...
#ifndef JSONCONS_JSONATA_JSONATA_HPP
#define JSONCONS_JSONATA_JSONATA_HPP
...
#include <jsoncons_ext/jsonata/jsonata_error.hpp>
...
namespace jsonata {
    ...
    public:
        ...
        public:
            ...
            reference evaluate(reference val, dynamic_resources<Json,JsonReference>& resources, std::error_code& ec) const override
            {
                ...
                if (step == 0)
                {
                    ec = jsonata_errc::step_cannot_be_zero;
                    return resources.null_value();
                }
        ...
        public:
            ...
            const function_base* get_function(const string_type& name, std::error_code& ec) const
            {
                ...
                {
                    ec = jsonata_errc::unknown_function;
                    return nullptr;
                }
                return it->second;
            }
        ...
        public:
            ...
            jsonata_expression(const jsonata_expression& expr) = delete;
            jsonata_expression& operator=(const jsonata_expression& expr) = delete;

            jsonata_expression(jsonata_expression&& expr)
                : resources_(std::move(expr.resources_)),
                  output_stack_(std::move(expr.output_stack_))
            {
            }

            jsonata_expression(static_resources&& resources,
            ...
            Json evaluate(reference doc)
            {
                ...
                if (ec)
                {
                    JSONCONS_THROW(jsonata_error(ec));
                }
                return result;
            }
            ...
            static jsonata_expression compile(const string_view_type& expr)
            {
                jsoncons::jsonata::detail::jsonata_evaluator<Json,const Json&> evaluator;
                std::error_code ec;
                jsonata_expression result = evaluator.compile(expr.data(), expr.size(), ec);
                if (ec)
                {
                    JSONCONS_THROW(jsonata_error(ec, evaluator.line(), evaluator.column()));
                }
                return result;
            }
    ...
    public:
        ...
        jsonata_expression compile(const char_type* path, 
                                    std::size_t length,
                                    std::error_code& ec)
        {
                ...
                switch (state_stack_.back())
                {
                    ...
                    case path_state::lhs_expression: 
                    {
                        switch (*p_)
                        {
                            ...
                            default:
                                ...
                                {
                                    ec = jsonata_errc::expected_identifier;
                                    return jsonata_expression();
                                }
                                break;
                        };
                    ...
                    case path_state::quoted_string_escape_char:
                        switch (*p_)
                        {
                            ...
                            case 'u':
                                ...
                                break;
                            default:
                                ec = jsonata_errc::illegal_escaped_character;
                                return jsonata_expression();
                        }
                        break;
                    ...
                    case path_state::escape_expect_surrogate_pair1:
                        switch (*p_)
                        {
                            case '\\': 
                                ...
                                break;
                            default:
                                ec = jsonata_errc::invalid_codepoint;
                                return jsonata_expression();
                        }
                        break;
                    ...
                    case path_state::literal: 
                        switch (*p_)
                        {
                            case '`':
                            {
                                ...
                                if (parse_ec)
                                {
                                    ec = jsonata_errc::invalid_literal;
                                    return jsonata_expression();
                                }
                            ...
                            case '\\':
                                ...
                                {
                                    ec = jsonata_errc::unexpected_end_of_input;
                                    return jsonata_expression();
                                }
                                ++p_;
                                ++column_;
                    ...
                    case path_state::bracket_specifier:
                        switch(*p_)
                        {
                            ...
                            case '-':case '0':case '1':case '2':case '3':case '4':case '5':case '6':case '7':case '8':case '9':
                                ...
                                break;
                            default:
                                ec = jsonata_errc::expected_index_expression;
                                return jsonata_expression();
                        }
                        break;
                    ...
                    case path_state::expect_multi_select_list:
                        switch(*p_)
                        {
                            ...
                            case ':':
                            case '-':case '0':case '1':case '2':case '3':case '4':case '5':case '6':case '7':case '8':case '9':
                                ec = jsonata_errc::expected_multi_select_list;
                                return jsonata_expression();
                            case '*':
                                push_token(token(jsoncons::make_unique<list_projection>()), ec);
                                if (ec) {return jsonata_expression();}
                        ...
                        switch(*p_)
                        {
                            case ']':
                            {
                                ...
                                else
                                {
                                    ...
                                    if (!r)
                                    {
                                        ec = jsonata_errc::invalid_number;
                                        return jsonata_expression();
                                    }
                            ...
                            default:
                                ec = jsonata_errc::expected_rbracket;
                                return jsonata_expression();
                        }
                        break;
                    ...
                    case path_state::expect_rparen:
                        switch (*p_)
                        {
                            ...
                            case ')':
                                ...
                                break;
                            default:
                                ec = jsonata_errc::expected_rparen;
                                return jsonata_expression();
                        }
                        break;
                    ...
                    case path_state::cmp_eq:
                    {
                        switch(*p_)
                        {
                            case '=':
                                ...
                                break;
                            default:
                                ec = jsonata_errc::expected_comparator;
                                return jsonata_expression();
                        }
                        break;
                    }
                    ...
                    case path_state::expect_rbrace:
                    {
                        switch(*p_)
                        {
                            ...
                            default:
                                ec = jsonata_errc::expected_rbrace;
                                return jsonata_expression();
                        }
                        break;
                    }
                    case path_state::expect_colon:
                    {
                        switch(*p_)
                        {
                            ...
                            case ':':
                                ...
                                break;
                            default:
                                ec = jsonata_errc::expected_colon;
                                return jsonata_expression();
                        }
                        break;
                    }
            ...
            return jsonata_expression(std::move(resources_), std::move(output_stack_));
        }
        ...
        void push_token(token&& tok, std::error_code& ec)
        {
            switch (tok.type())
            {
                case token_kind::end_filter:
                {
                    ...
                    {
                        ec = jsonata_errc::unbalanced_braces;
                        return;
                    }
    ...
    template <class Json>
    using jsonata_expression = typename jsoncons::jsonata::detail::jsonata_evaluator<Json,const Json&>::jsonata_expression;
    ...
    template <class Json>
    jsonata_expression<Json> make_expression(const typename json::string_view_type& expr)
    {
        return jsonata_expression<Json>::compile(expr);
    }
    ...
    jsonata_expression<Json> make_expression(const typename json::string_view_type& expr,
                                              std::error_code& ec)
    {
        return jsonata_expression<Json>::compile(expr, ec);
    }
